class TweepIcons {
  constructor(element) {
    ...
    this.createTweepIcons()
  }

  createTweepIcons() {
		let tweep = document.createElement("p")
      ...
      `<div class="tweet-icons">
		...
		this.element.insertBefore(tweep, this.element.firstChild)
  }
}
...
class Tweep {
  ...
  createTweep() {
    ...
    if (this.element.attributes.getNamedItem('video') != null) {
      foo = foo.concat(
    ...
    tweepDiv.insertAdjacentElement('beforeend', tweepIcons)

    this.element.innerText = ''
    this.element.insertBefore(tweepDiv, this.element.firstChild)
  }
}

registeredClasses["TweepIcons"] = TweepIcons
registeredClasses["Tweep"] = Tweep
